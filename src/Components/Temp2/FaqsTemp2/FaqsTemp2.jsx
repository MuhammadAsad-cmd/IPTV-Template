...
import FAQAccordionTemp from "../FaqsItemsTemp2/FAQAccordionTemp";
  ...
  return (
    <>
      ...
      <div className="py-[10px] md:py-[50px] px-[5px] md:px-[10px] max-w-[830px] container mx-auto">
        ...
        <div className="bg-[#FAFDF708] mx-[10px] my-[50px] py-[50px] px-[15px] text-white BorderRadius">
