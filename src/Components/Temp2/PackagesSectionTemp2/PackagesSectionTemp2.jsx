    ...
    <>
      <div>
        ...
        <div className="p-[10px]  pt-5">
          ...
          >
            ...
            <SwiperSlide>
              <img src="/images/download-23.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-24.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-25.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-26.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-34.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-36.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-37.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-42.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
            <SwiperSlide>
              <img src="/images/download-43.jpeg" alt="img" className="mr-5 " />
            </SwiperSlide>
          </Swiper>
        </div>
      </div>
      ...
      <div className="p-[10px] max-w-[1450px] container mx-auto pt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 xl:grid-cols-4 p-4">
          <div className="border text-white h-full border-[#fdf7fb1a]  p-[50px] rounded-2xl">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <div className="mb-5">
                ...
                <span className="mb-9 text-[#95dd4c] text-xl font-normal Inter">
                  (+1 Month Free)
                </span>{" "}
              </div>
            </div>
            ...
            <div>
              ...
              <button className="py-[15px] mx-auto mb-5 w-auto gap-2 text-lg px-[25px] bg-[#BBDC5D] text-[#121212] flex items-center justify-center font-bold rounded-3xl max-h-12">
          ...
          <div className="text-black h-full bg-[#95DD4C]  p-[50px] rounded-2xl">
            <div className="flex flex-col items-center justify-center text-center">
              <div className="mb-5">
            ...
            <div>
              ...
              <button className="py-[15px] mx-auto mb-5 w-auto gap-2 text-lg px-[25px] bg-[#121212] text-[#FAFDF7] flex items-center justify-center font-bold rounded-3xl max-h-12">
                <CgScreen className="font-black text-xl" />
                <p>Buy Now</p>
              </button>
              ...
              <div className="flex items-center justify-center text-center gap-5">
                <img src="/images/devices-2.webp" alt="img" />
              </div>
            </div>
          </div>
          <div className="border text-white h-full border-[#fdf7fb1a]  p-[50px] rounded-2xl">
      ...
      <div className="max-w-[1140px] mx-auto container px-[10px] py-3 md:py-[50px]">
        <div className="flex items-center md:flex-row flex-col justify-center m-4 border border-[#fdf7fb1a] rounded-lg">
          ...
          <div className="flex w-full md:w-1/3 flex-col gap-y-5 p-[15px] border-[#fdf7fb1a] items-center  justify-center">
            ...
            <button className="py-[15px] px-6 bg-[#95DD4C] text-[#121212] flex items-center justify-center font-bold rounded-3xl max-h-10">
              Free Trial
            </button>
          </div>
        </div>
...
export default PackagesSectionTemp2;
